...
function isValidTriangle(a, b, c) {
   ...
   // Assertions
   console.assert(isValidTriangle(3, 3, 3) === true);
   console.assert(isValidTriangle(2, 3, 3) === true);
   console.assert(isValidTriangle(-4, 7, 5) === false);
   console.assert(isValidTriangle(3, 3, 10) === false);