...
test("check is a valid triangle", () => {
  expect(isValidTriangle(1, 0, 3)).toBe("Not a valid triangle");
});

test("check is a valid triangle", () => {
  expect(isValidTriangle(-2, 0, 3)).toBe("Not a valid triangle");
});
test("check is a valid triangle", () => {
  expect(isValidTriangle(6, 6, 3)).toBe("is a valid triangle");
});
