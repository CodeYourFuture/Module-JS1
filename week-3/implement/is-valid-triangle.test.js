...
test("checks if shape is a triangle", function () {
  expect(isValidTriangle(10, 10, 0)).toBe(false);
});

test("checks if shape is a triangle", function () {
  expect(isValidTriangle(0, 50, 50)).toBe(false);
});

test("checks if shape is a triangle", function () {
  expect(isValidTriangle(20, 40, 50)).toBe(true);
});
