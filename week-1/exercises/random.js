...
/*
Here is an explanation of the random number generation expression:
...
- (maximum - minimum + 1) calculates the number of integers between the min and max values, inclusive. In this case it's 100 - 1 + 1 = 100.
