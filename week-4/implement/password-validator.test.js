...
function isPasswordValid(password, previous) {
...
test("Check if it is a valid password", function () {
    const currentOutput = isPasswordValid("bdhbhbd", previous);
    const targetOutput = false;
    expect(currentOutput).toBe(targetOutput);
});

test("Check if it is a valid password", function () {
    const currentOutput = isPasswordValid("SecurePWUV123#", previous);
    const targetOutput = true;
    expect(currentOutput).toBe(targetOutput);
});

test("Check if it is a valid password", function () {
    const currentOutput = isPasswordValid("ADcn!jk5",previous );
    const targetOutput = true;
    expect(currentOutput).toBe(targetOutput);
});

test("Check if it is a valid password", function () {
    const currentOutput = isPasswordValid("adT",previous );
    const targetOutput = false;
    expect(currentOutput).toBe(targetOutput);
});

test("Check if it is a valid password", function () {
    const currentOutput = isPasswordValid("*****", previous);
    const targetOutput = false;
    expect(currentOutput).toBe(targetOutput);
});
...
test("Check if it is a valid password", function () {
    const currentOutput = isPasswordValid("HiMy01233455",previous);
    const targetOutput = false;
    expect(currentOutput).toBe(targetOutput);
});
test("Check if it is a valid password", function () {
    const currentOutput = isPasswordValid("5Adniya&",previous);
    const targetOutput = true;
    expect(currentOutput).toBe(targetOutput);
});